export const appConfig = {
  ...
  storageKeys: {
    ...
    offlineTileManifest: "exploracion-offline-tile-manifest-v1",
    draftHintDismissed: "exploracion-map-draft-hint-dismissed",
  },
  arcgisSdk: {
    version: "4.33",
    useLocal: true,
    cdnBaseUrl: "https://js.arcgis.com/4.33/@arcgis/core",
  ...
  map: {
    ...
    captureTolerance: 12,
    defaultZoom: 15,
    offlineTileLayerUrl: "https://services.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer",
    offlineZoomMin: 10,
    offlineZoomMax: 16,
    gpsSampleCount: 5,
    gpsTimeoutMs: 18000,
