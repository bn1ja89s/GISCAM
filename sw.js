const APP_CACHE_NAME = "pwa-exploracion-app-v31";
const ARCGIS_CACHE_NAME = "pwa-exploracion-arcgis-v31";
...
self.addEventListener("fetch", (event) => {
  ...
  if (requestUrl.origin === self.location.origin && requestUrl.pathname.endsWith("/js/config.js")) {
