    ...
    <section class="page-grid stack">
      <article class="card">
        ...
        <div class="card__body stack">
          ...
          <p class="muted sync-inline-message">${escapeHtml(syncMessage || "Si no hay backend configurado, los registros quedaran listos localmente para una futura integracion.")}</p>
                  ...
                  (item) => `
                    <div class="list-item queue-item">
                      ...
                      <div class="list-item__meta">
                        <span>Ref: ${escapeHtml(item.payload?.hole_id || item.payload?.cod_exploracion || "-")}</span>
