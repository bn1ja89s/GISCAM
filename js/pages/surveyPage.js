...
export function renderSurveyPage({ activeProject, activeProjectCollars, activeProjectSurveys, editingSurvey }) {
  return `
    <section class="page-grid page-grid--2">
      <article class="card">
        ...
        <div class="card__body">
          ${renderSurveyForm({ activeProject, activeProjectCollars, editingSurvey })}
        </div>
      </article>
