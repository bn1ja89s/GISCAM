...
export function renderAssayPage({ activeProject, activeProjectCollars, activeProjectAssays, editingAssay }) {
  return `
    <section class="page-grid page-grid--2">
      <article class="card">
        ...
        <div class="card__body">
          ${renderAssayForm({ activeProject, activeProjectCollars, editingAssay })}
        </div>
      </article>
