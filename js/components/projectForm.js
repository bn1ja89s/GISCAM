    ...
    <form id="project-form" class="stack" autocomplete="off">
      ...
      <div class="grid-fields">
        <label class="field">
          ...
          <input class="input" name="cod_exploracion" value="${escapeHtml(project?.cod_exploracion || "")}" required>
        </label>
        <label class="field">
          <span>Concesion / area</span>
          <input class="input" name="concesion_area" value="${escapeHtml(project?.concesion_area || "")}" required>
        </label>
      </div>
      <div class="grid-fields">
        <label class="field">
          <span>Codigo catastral</span>
          <input class="input" name="cod_catastral" value="${escapeHtml(project?.cod_catastral || "")}">
        </label>
        <label class="field">
          <span>Tecnico</span>
